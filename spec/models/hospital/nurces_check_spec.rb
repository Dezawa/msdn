...
describe Hospital::Nurce do
  ...
  [[2,"01111220",3,1,[[:renkin,5]],"6連勤OUT"],
   ...
   nil
    ...
    it  msg0 do
      ...
      expect(nurce37.check(day,shift,false)).to match_array ret
    end
  }
  ...
  [[2,"0_111220",3,"1",[[:renkin,5]],"6連勤OUT"],
   ...
   nil
    ...
    it msg0 do
      nurce37 = nurce( 37)
      nurce37.set_shift_days(day0,pat)
      expect(nurce37.check_at_assign(day,shift,false)).to match_array ret
    end
  }
  ...
  [[2,"0_11120" ,3,"1",nil,"6連勤OK"],
   ...
   nil
    ...
    it msg0 do
      nurce37 = nurce( 37)
      nurce37.set_shift_days(day0,pat)
      expect(nurce37.check_at_assign(day,shift,false)).to eq ret
    end
  }
  ...
  [  ["00__________0000000000111110000",3,3,["330", [[2], [], [], [1]]],[:renkin],"2/3へ3はlongpatern9"],
     ...
     nil
       ...
       next unless init
       it "勤務初期値 #{init} で #{day}日に勤務#{shift}で長い割り当てをいれる(#{msg})" do
      nurce=nurce 44
