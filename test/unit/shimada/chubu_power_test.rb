...
assert_equal [944.6, 893.2, 509.4, 383.0, 381.0, 822.8, 915.4, 985.0, 973.8, 976.6, 984.4, 956.4, 801.4, 926.0, 908.6, 905.0, 900.2, 895.4, 896.0, 888.6, 903.8, 877.2, 911.2, 880.4],
    power.powers
  end
