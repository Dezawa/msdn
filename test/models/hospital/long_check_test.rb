...
class Hospital::LongCheckTest < ActiveSupport::TestCase
  ...
  [ [38,2,"3",0,"330"],[38,4,"3",0,"330"],[38,2,"2",1,"220"],
    [38,3,"2",1,"220"],
    [36,1,"3",0,:shinya],
    [35,1,"2",0,"220330"],[35,1,"2",1,"220"],[35,1,"2",2,"2"],
    [39,1,"3",0,"330"],[39,1,"3",1,"3"]
  ...
  [ [36,1,"3",0,:shinya],[36,1,"3",1,"3"],
    [45,1,"3",0,:no_space],[45,1,"3",1,"3"],
    [34,1,"2",0,:no_space],[34,1,"2",1,:renkin],[34,1,"2",2,"2"],
    [46,1,"2",0,:renkin],[46,1,"2",1,:renkin],[46,1,"2",2,"2"],
    [51,1,"2",0,:no_space],[51,1,"2",1,:no_space],[51,1,"2",2,"2"],
  ].each{ |nurce,day,sft,pat_id,ret|
    long_pat = long_patern(sft,pat_id)
    pat = long_pat.patern
    must "看護師ID#{nurce} 2/#{day}に #{long_pat.patern} OK" do
