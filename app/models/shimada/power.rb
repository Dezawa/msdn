...
{
1 => {
:ave => [ 229.369 ,-3.925 ,-1.121 ,0.033 ,0.007],
:max => [ 289.200 ,-5.624 ,-1.255 ,0.015 ,0.013],
:min => [ 169.539 ,-2.227 ,-0.987 ,0.051 ,0.002]
},
2 => {
...
3 => {
:ave => [ 555.868 ,-1.145 ,0.053 ,-0.054 ,-0.023],
:max => [ 608.916 ,3.893 ,0.849 ,-0.076 ,-0.021],
:min => [ 502.821 ,-6.184 ,-0.742 ,-0.031 ,-0.025]
},
4 => {
:ave => [ 610.350 ,-2.327 ,0.646 ,-0.024 ,-0.028],
:max => [ 669.108 ,-0.665 ,1.281 ,0.017 ,-0.026],
:min => [ 551.593 ,-3.989 ,0.011 ,-0.064 ,-0.030]
        }
  }
