...
#    include DeprecatedErrorMethods
    ...
    def full_messages
      ...
      each do |attribute, messages|
        ...
        if attribute == :base
          ...
          messages.each do |m|
            full_messages <<  m #I18n.t(:"errors.format", options.merge(:message => m))
          end
        end
      end
    ...
    def generate_message(attribute, type = :invalid, options = {})
      ...
      defaults = @base.class.lookup_ancestors.map do |klass|
        [ "#{@base.class.i18n_scope}.errors.models.#{klass.model_name.i18n_key}.attributes.#{attribute}.#{type}".to_sym,
          "#{@base.class.i18n_scope}.errors.models.#{klass.model_name.i18n_key}.#{type}".to_sym ]
      end

      defaults << options.delete(:message)
      defaults << "#{@base.class.i18n_scope}.errors.messages.#{type}".to_sym
      defaults << "errors.attributes.#{attribute}.#{type}".to_sym
      defaults << "errors.messages.#{type}".to_sym
